...
To read more about developing and contributing to the project, see :doc:`contribution` and :doc:`testing`.


TODO MOVE THE REST OF THIS SOMEWHERE ELSE, MAYBE CONTRIBUTING, MAYBE PIPELINE
